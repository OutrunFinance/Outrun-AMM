...
import "./OutrunAMMPair02.sol";
import "../blast/GasManagerable.sol";

contract OutrunAMMFactory02 is IOutrunAMMFactory, Ownable, GasManagerable {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        pair = address(new OutrunAMMPair02{salt: _salt}(gasManager));
