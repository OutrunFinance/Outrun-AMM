                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            /* bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(OutrunAMMPair01).creationCode)); */
                            hex"9628ca24c7457d60d9bc957dbecea06a2404d3c4fb4672c547cf208ee64d0f3b" // 0.3% init code hash
                        )
                    )
                )
            )
