...
library OutswapV1Library01 {
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"e2a354dc803d41445c52ecd5064240d723bef3b0ca903d44e3bee08d77fa3bd6" // 0.3% init code hash
                        )
                    )
                )
            )
    ...
    function quote(uint256 amountA, uint256 reserveA, uint256 reserveB) internal pure returns (uint256 amountB) {
        require(amountA > 0, "OutswapV1Library: INSUFFICIENT_AMOUNT");
        require(reserveA > 0 && reserveB > 0, "OutswapV1Library: INSUFFICIENT_LIQUIDITY");
    ...
    {
        require(path.length >= 2, "OutswapV1Library: INVALID_PATH");
